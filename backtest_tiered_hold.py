"""
backtest_tiered_hold.py - N200c + tiered hold periods.

Single change from V6 N200c:
  BUY   signals → hold_days = 8 (unchanged)
  WATCH signals → hold_days = 5 (freed 3 days earlier)

Hypothesis: freeing WATCH capital 3 days early improves
capital rotation without meaningfully hurting returns.
WATCH = only 8.6% of trades — conservative change.

N200c baseline: Rs 20,468/mo, 55.8% WR, 8.1% dd
Invalidated if: monthly < Rs 18,000, WR < 54%, dd > 9%
"""
...
HOLD_DAYS        = 8    # BUY signals
WATCH_HOLD_DAYS  = 5    # WATCH signals
MIN_RR           = 1.5
ATR_SL_MULT      = 2.0
ATR_TGT_MULT     = 3.0
...
# Nifty 50 set — OE restricted to these (Fix 1)
NIFTY50 = {
...
WATCHLIST = [
    ...
    "SUNDARMFIN.NS","SHRIRAMFIN.NS",# PIRAMALENT.NS removed (delisted)
    # PSU (5 — IRFC/RAILTEL removed: weak WR)
    "RVNL.NS","PFC.NS","RECLTD.NS",
    "HUDCO.NS","NBCC.NS",
]
...
SECTOR_MAP = {
    ...
    "FEDERALBNK.NS":"BANKING","BANDHANBNK.NS":"BANKING","IDFCFIRSTB.NS":"BANKING",
    "INDUSINDBK.NS":"BANKING","AUBANK.NS":"BANKING","CANBK.NS":"BANKING",
    "PNB.NS":"BANKING","BANKBARODA.NS":"BANKING","RBLBANK.NS":"BANKING",
    # IT
    "INFY.NS":"IT","WIPRO.NS":"IT","HCLTECH.NS":"IT","LTIM.NS":"IT",
    "COFORGE.NS":"IT","MPHASIS.NS":"IT","TCS.NS":"IT","TECHM.NS":"IT",
    "PERSISTENT.NS":"IT","OFSS.NS":"IT","KPITTECH.NS":"IT",
    # PHARMA
    "SUNPHARMA.NS":"PHARMA","DRREDDY.NS":"PHARMA","DIVISLAB.NS":"PHARMA",
    "CIPLA.NS":"PHARMA","AUROPHARMA.NS":"PHARMA","TORNTPHARM.NS":"PHARMA",
    "ALKEM.NS":"PHARMA","LUPIN.NS":"PHARMA","IPCALAB.NS":"PHARMA",
    # AUTO
    "MARUTI.NS":"AUTO","EICHERMOT.NS":"AUTO","HEROMOTOCO.NS":"AUTO",
    "BAJAJ-AUTO.NS":"AUTO","M&M.NS":"AUTO","APOLLOTYRE.NS":"AUTO",
    "BALKRISIND.NS":"AUTO","MOTHERSON.NS":"AUTO","BOSCHLTD.NS":"AUTO",
    "EXIDEIND.NS":"AUTO","BHARATFORG.NS":"AUTO",
    # FMCG
    "HINDUNILVR.NS":"FMCG","ITC.NS":"FMCG","NESTLEIND.NS":"FMCG",
    "BRITANNIA.NS":"FMCG","DABUR.NS":"FMCG","MARICO.NS":"FMCG",
    "GODREJCP.NS":"FMCG","EMAMILTD.NS":"FMCG","COLPAL.NS":"FMCG",
    "TATACONSUM.NS":"FMCG","VBL.NS":"FMCG",
    # CAPITAL
    "LT.NS":"CAPITAL","ABB.NS":"CAPITAL","SIEMENS.NS":"CAPITAL",
    "HAVELLS.NS":"CAPITAL","POLYCAB.NS":"CAPITAL","BEL.NS":"CAPITAL",
    "HAL.NS":"CAPITAL","BHEL.NS":"CAPITAL","CUMMINSIND.NS":"CAPITAL",
    "THERMAX.NS":"CAPITAL","GRINDWELL.NS":"CAPITAL",
    # CHEMICAL
    "DEEPAKNTR.NS":"CHEMICAL","PIDILITIND.NS":"CHEMICAL","ASIANPAINT.NS":"CHEMICAL",
    "AARTIIND.NS":"CHEMICAL","NAVINFLUOR.NS":"CHEMICAL","ATUL.NS":"CHEMICAL",
    "GUJGASLTD.NS":"CHEMICAL","LINDEINDIA.NS":"CHEMICAL",
    # METAL
    "HINDALCO.NS":"METAL","TATASTEEL.NS":"METAL","JSWSTEEL.NS":"METAL",
    "COALINDIA.NS":"METAL","NMDC.NS":"METAL","SAIL.NS":"METAL",
    "VEDL.NS":"METAL","NATIONALUM.NS":"METAL","APLAPOLLO.NS":"METAL",
    # ENERGY
    "TATAPOWER.NS":"ENERGY","RELIANCE.NS":"ENERGY","ONGC.NS":"ENERGY",
    "POWERGRID.NS":"ENERGY","NTPC.NS":"ENERGY","ADANIGREEN.NS":"ENERGY",
    "TORNTPOWER.NS":"ENERGY","CESC.NS":"ENERGY","NHPC.NS":"ENERGY",
    "ADANIPOWER.NS":"ENERGY","IOC.NS":"ENERGY","BPCL.NS":"ENERGY",
    # CONSUMER
    "TITAN.NS":"CONSUMER","DMART.NS":"CONSUMER","TRENT.NS":"CONSUMER",
    "PAGEIND.NS":"CONSUMER","VOLTAS.NS":"CONSUMER","DIXON.NS":"CONSUMER",
    "KAJARIACER.NS":"CONSUMER","BATAINDIA.NS":"CONSUMER","VGUARD.NS":"CONSUMER",
    "WHIRLPOOL.NS":"CONSUMER",
    # INFRA
    "ADANIPORTS.NS":"INFRA","ULTRACEMCO.NS":"INFRA","SHREECEM.NS":"INFRA",
    "ACC.NS":"INFRA","AMBUJACEM.NS":"INFRA","DLF.NS":"INFRA",
    "GODREJPROP.NS":"INFRA","OBEROIRLTY.NS":"INFRA",
    # NBFC (new)
    "BAJAJFINSV.NS":"NBFC","CHOLAFIN.NS":"NBFC","MUTHOOTFIN.NS":"NBFC",
    "SUNDARMFIN.NS":"NBFC","SHRIRAMFIN.NS":"NBFC","PIRAMALENT.NS":"NBFC",
    # PSU (new)
    "RVNL.NS":"PSU","PFC.NS":"PSU","RECLTD.NS":"PSU",
    "HUDCO.NS":"PSU","NBCC.NS":"PSU",
}
...
SECTOR_PROXY = {
    ...
    "METAL":    "^CNXMETAL",
    "CAPITAL":  "^CNXINFRA",
    "CHEMICAL": "^CNXFMCG",    # fixed in V6
    "CONSUMER": "^CNXCONSUMP", # fixed in V6 (may fail — fallback to FMCG)
    "ENERGY":   "^CNXENERGY",
    "INFRA":    "^CNXINFRA",
...
def run_backtest():
    ...
    for ticker,ddf in all_daily.items():
        ...
        for di in range(250,len(dates)):
            ...
            # OE Nifty50 gate (Fix 1)
            if setup == "OVERSOLD_EXHAUSTION" and ticker not in NIFTY50:
                continue
            ...
            # Tiered hold: score signal to get BUY/WATCH label
            _score = sum([
                bool(sector_up),
                rr >= 1.5,
                ev >= 2.0,
                cap >= 120000,
                2 if setup == "RSI_DIVERGENCE" else
                1 if setup in ("TREND_PULLBACK","BREAKOUT_PULLBACK") else 0
            ])
            _label = "BUY" if _score >= 4 else "WATCH"
            _hold  = HOLD_DAYS if _label == "BUY" else WATCH_HOLD_DAYS
            exit_r,exit_p,partial=_sim(ddf,di,sl,tgt,part,_hold)
            ...
            trades.append({
                ...
                "setup_type":setup,"conf_label":_label,"sector":sector,"sector_uptrend":sector_up,
    ...
    outfile=f"backtest_tiered_{ts}.csv"
...
def _print_results(df):
    print("\n"+"="*60)
    print("  BACKTEST TIERED HOLD RESULTS")
    print("="*60)
    ...
    print(f"\n  COMPARISON")
    print(f"  {'Metric':<22} {'N200c':>8} {'Tiered':>8}")
    print(f"  {'-'*56}")
    print(f"  {'Win Rate':<22} {'55.8%':>8} {wr:.1f}%")
    print(f"  {'Monthly avg':<22} {'20,468':>8} {tot/(yrs*12):,.0f}")
    print(f"  {'Annual return':<22} {'40.9%':>8} {tot/CAPITAL/yrs*100:.1f}%")
    print(f"  {'Max drawdown':<22} {'8.1%':>8} {mdd*100:.1f}%")
    print(f"  {'Profit factor':<22} {'1.39x':>8} {pf:.2f}x")
    ...
    beats_n200c = sum([wr>55.8, tot/(yrs*12)>20468, mdd*100<8.1, pf>1.39])
    print(f"\n  VERDICT vs V6(45):   {beats_v6_45}/4 beaten")
    print(f"  VERDICT vs V6(45):  {beats_v6}/4 beaten")
    invalid=[]
    if wr<54.0: invalid.append(f"WR {wr:.1f}% < 54% — cutting winners early")
    if tot/(yrs*12)<18000: invalid.append(f"Monthly Rs {tot/(yrs*12):,.0f} < Rs 18,000 — meaningful regression")
    if mdd*100>9.0: invalid.append(f"Drawdown {mdd*100:.1f}% > 9% limit")
    if pf<1.45: invalid.append(f"Profit factor {pf:.2f}x < V4 1.45x")
    if len(df)/yrs<80: invalid.append(f"Only {len(df)/yrs:.0f} trades/yr < 80 min")
    if invalid:
        print(f"  V6 INVALIDATED:")
